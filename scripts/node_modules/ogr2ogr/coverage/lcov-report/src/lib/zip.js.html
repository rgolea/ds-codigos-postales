...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/zip.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/lib/</a> zip.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  finder.on('error', <span class="fstat-no" title="function not covered" >function(er) {</span>
...
<span class="cstat-no" title="statement not covered" >    finder.stop() </span>// prevent multiple callbacks, stop at first error
  ...
  finder.on('end', function() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!found) <span class="cstat-no" title="statement not covered" >return cb(new Error('No valid files found'))</span>
    cb(null, found)
  })
}
&nbsp;
...
&nbsp;
  fs.readdir(dpath, function(er, files) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (er) <span class="cstat-no" title="statement not covered" >return zs.emit('error', er)</span>
&nbsp;
    files.forEach(function(file) {
      var f = fs.createReadStream(path.join(dpath, file))
      zs.append(f, {name: file})
    })
    zs.finalize(<span class="fstat-no" title="function not covered" >function(er) {</span>
